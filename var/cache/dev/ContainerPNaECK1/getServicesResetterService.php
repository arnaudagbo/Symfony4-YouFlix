...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['validator'])) + (int) (isset($this->privates['form.type.entity']));
}), array('profiler' => 'reset', 'debug.validator' => 'reset', 'form.type.entity' => 'reset'));
